...
class ConferenceRepository @Inject constructor(
    ...
    val conferences: Flowable<Resource<List<ConferenceEntity>>>
        get() =
            object : NetworkBoundResource<List<ConferenceEntity>, List<ConferenceRemote>>() {
    ...
    fun conferencesWithEvents(): Flowable<Resource<List<ConferenceWithEvents>>> =
            object : NetworkBoundResource<List<ConferenceWithEvents>, List<ConferenceRemote>>() {
